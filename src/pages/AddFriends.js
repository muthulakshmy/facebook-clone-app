...
import { Box, Card, CardContent, CardHeader, Avatar, Typography, Button, CardMedia, Paper, Grid } from '@mui/material';
      ...
      {userData.users.map((user) => (
        <Card key={user.id} sx={{ marginBottom: 2,width:200,height:300}}>
          ...
          <CardContent sx={{p:2,}} >
            ...
            <Button variant="contained" sx={{backgroundColor:"lightgray" ,color:"black" ,width:170,fontSize:12}} >
             Delete
            </Button>
          </CardContent>
        </Card>
